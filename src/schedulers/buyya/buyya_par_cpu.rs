...
use para_graph::algorithms::floyd_warshall::floyd_warshall_par_cpu;
...
mod tests {
    ...
    fn test_buyya() {
        ...
        let assignments = buyya_par_cpu(&topo, &tasks);
