...
use scheduler_benchmark::schedulers::heft::heft;
...
fn main() {
    ...
    heft(&topology_graph, &task_graph);

    para_graph::graph::dot::to_dot("heft_task.dot", &task_graph);
    para_graph::graph::dot::to_dot("heft_topology.dot", &topology_graph);
}
